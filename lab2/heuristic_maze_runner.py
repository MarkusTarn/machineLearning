...
runner1 = Runner(maze_small)
runner2 = Runner(maze_medium)
runner3 = Runner(maze_big)
print("Runner 1:")
runner1.maze.print_map(runner1.find_bfs())
runner1.maze.print_map(runner1.find_greedy())
runner1.maze.print_map(runner1.find_astar())
print("Runner 2:")
runner2.maze.print_map(runner2.find_bfs())
runner2.maze.print_map(runner2.find_greedy())
runner2.maze.print_map(runner2.find_astar())
print("Runner 3:")
runner3.maze.print_map(runner3.find_bfs())
runner3.maze.print_map(runner3.find_greedy())
runner3.maze.print_map(runner3.find_astar())
